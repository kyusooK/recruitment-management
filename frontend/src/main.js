...
pluralCaseList.push( {plural: "resumes/resumes", pascal: "ResumeResume"} )

pluralCaseList.push( {plural: "interviews/interviews", pascal: "InterviewInterview"} )

pluralCaseList.push( {plural: "users/users", pascal: "UserUser"} )

pluralCaseList.push( {plural: "reports/applicationAnalyzeData", pascal: "ReportApplicationAnalyzeData"} )
